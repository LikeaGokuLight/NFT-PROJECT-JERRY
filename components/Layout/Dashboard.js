...
import {Autocomplete, Collapse, Container, ListItem, Stack, TextField} from "@mui/material";
...
const Dashboard = ({data, getDataSorted, title, children}) => {
  ...
  const SortBy = ({onSortHandle}) => {
    ...
    return (
      <Stack spacing={1} sx={{ width: '100%', display: open ? 1 : 'none' }}>
        <Autocomplete
          freeSolo
          id="free-solo"
          disableClearable
        ...
        <Drawer variant="permanent" open={open}>
          <DrawerHeader sx={{margin: '2rem 0'}}>
            <div style={{display: 'flex'}}>
              ...
              <Link href={'/'}>
                <a>
                  <Typography variant="h5" noWrap component="div" sx={{marginLeft: '10px'}}>
                    NFT <br/> JERRY
                  </Typography>
                </a>
              </Link>
          ...
          <List>
            ...
            >
              ...
              <Stack spacing={1} sx={{ width: 300, display: open ? 1 : 'none' }} >
                <Autocomplete
            ...
            pathname !== '/' && (
              <List>
                ...
                >
                  ...
                  <ListItem spacing={2} sx={{ width: 300, display: open ? 1 : 'none' }}>
